...
//                  arrive() сообщает фазеру о завершении участника в текущей фазе и увеличивает
//                  количество завершенных участников. Когда количество завершенных участников достигает общего
//                  числа зарегистрированных участников в фазере, фазер переходит на следующую фазу.
                    break;
                case 6:
